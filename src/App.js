...
import WhyNovaRadPage from "./pages/WhyNovaRadPage";
...
function AppRoutes() {
  return (
    <Routes>
      ...
      <Route path="/why-novarad" element={<WhyNovaRadPage />} />
      ...
      <Route
        ...
        element={
          <PrivateRoute roles={["radiologist", "technician", "receptionist"]}>
            <StaffDashboard />
          </PrivateRoute>
        }
      />
      ...
      />
      <Route
        path="/staff/report/:orderId"
        element={
          <PrivateRoute roles={["radiologist"]}>
            <RadiologyReport />
          </PrivateRoute>
        }
      />
