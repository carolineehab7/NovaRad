...
export function ImagingOrders() {
  ...
  if (loading)
    return (
      <DashboardLayout title="Imaging Orders">
        <Spinner />
      </DashboardLayout>
    );
  ...
  return (
    <DashboardLayout title="Imaging Order Management">
      ...
      >
        {[
          { key: "all", label: "All Orders", color: "var(--nova-cyan)" },
      ...
      <Card title={`Imaging Orders (${filteredOrders.length})`}>
        <DataTable
          columns={[
            ...
            },
            {
              ...
              render: (v, row) =>
                user?.role === "radiologist" ? (
                  <Link
                    to={`/staff/report/${row.order_id}`}
                    style={{ textDecoration: "none" }}
                  >
                    <Button size="sm" variant={v ? "ghost" : "primary"}>
                      {v ? (row.signed ? "View" : "Edit") : "+ Write"}
                    </Button>
                  </Link>
                ) : v ? (
...
export function RadiologyReport() {
  ...
  if (loading)
    return (
      <DashboardLayout title="Radiology Report">
        <Spinner />
      </DashboardLayout>
    );
    ...
    <DashboardLayout title="Write Radiology Report">
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 2fr", gap: 24 }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
          ...
          {/* Images panel */}
          <Card
            title={`Imaging Files (${images.length})`}
            titleRight={
              <Button
                size="sm"
                variant="ghost"
          ...
          {data?.report && (
            ...
            >
              ...
              <div style={{ fontSize: "0.8rem", color: "var(--text-muted)" }}>
                Last updated: {data.report.report_date}
              </div>
          ...
          <div style={{ padding: 28 }}>
            ...
            >
              <div>
                ...
                >
                  Provide a thorough clinical interpretation for accurate
                  patient diagnosis.
                </div>
              </div>
              ...
              >
                ...
                {signed && (
                  ...
                  >
                    ⚠ Signing this report will add it to the patient's medical
                    record and make results visible.
                  </div>
                )}
              </div>
              ...
              <div style={{ display: "flex", gap: 12 }}>
                ...
                <Button
                  variant="ghost"
                  onClick={() => navigate("/staff/imaging-orders")}
                >
                  Cancel
                </Button>
              </div>
